...
def create_train_val(data, start_index, stop_index, past_history, future_target):
    '''
    ...
    '''
    x_train_uni, y_train_uni = univariate_data(data, start_index, stop_index, past_history, future_target)
    x_val_uni, y_val_uni = univariate_data(data, start_index, None,
                                       past_history,
                                       future_target)
