...
plt.hlines(
    max(prev_It), 0, len(prev_It), colors='violet', label='Stability: 47000'
    )
...
plt.plot(
    ...
    color='green',
    marker='o',
    label='Expected New Daily Infections'
    )
plt.plot(
    x_It,
    growth_It,
    color='red',
    marker='o',
    label='Confirmed New Daily Infections'
    )
plt.axvline(x=16, color='black', linestyle='dashed', label='Start Quarantine')
plt.axvline(x=24, color='blue', linestyle='dashed', label='Inflection Point')
plt.axvline(x=20, color='orange', label='Today: 12 March')
